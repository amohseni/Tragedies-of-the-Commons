...
shinyUI(fluidPage(
  ...
  fluidRow(style = "background-color:#F2F2F2; margin-top: 30px; margin-bottom: 30px; padding: 10px",
           column(
             ...
             p(
               tags$b("Description."),
               "A population of size \\(Z\\) is organized into groups of size \\(N\\). 
               Each individual can be understood as an AI researcher able to realize or ignore proposed norms of research and practice. Each group can be thought of as an organizational unit, such as a laboratory, university department, or collaborative, able to sustain shared norms.",
               tags$br(),
               tags$br(),
